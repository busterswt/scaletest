...
class Pinger(object):
    ...
    def ping(self, ip):
        ...
        keepPinging = True
        while keepPinging:
            ret = subprocess.Popen(['ip','netns','exec','qrouter-37ec25a1-d101-4a6c-a4fe-cf8603382cdf','ping', '-c', '1', '-W', '1', ip], stdout=subprocess.PIPE)
...
#    ping.hosts = ['127.0.0.1', '8.8.8.8', '192.168.0.4', '192.168.0.5','192.168.0.6']
    ...
    for i in range(int(sys.argv[1])):    
        ...
        host_addr,server = myping.main(random_server_name(),'b415ae07-97fb-4515-b03e-0f9bed2267b2')
